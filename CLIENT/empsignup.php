...
include("./include/header.php");
	...
	if(isset($_REQUEST['in']))
	{
		...
		$q13=$_REQUEST['txt13'];
			...
			$q="INSERT INTO  emp ( 	empid,name,lastname,designation,address,city,pincode,phno,doj,gender,emailid,loginid,password) VALUES ('$q1','$q2','$q3','$q4','$q5','$q6','$q7','$q8','$q9','$q10','$q11','$q12','$q13')";
...
?>
<center>
<form method="post" action="../admin/insertemp.php">
